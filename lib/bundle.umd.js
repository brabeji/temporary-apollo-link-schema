...
var SchemaLink = (function (_super) {
    ...
    function SchemaLink(_a) {
        var schema = _a.schema, rootValue = _a.rootValue;
    ...
    SchemaLink.prototype.request = function (operation) {
        ...
        return new apolloLink.Observable(function (observer) {
            Promise.resolve(graphql.execute(_this.schema, operation.query, _this.rootValue, operation.getContext(), operation.variables, operation.operationName))
                .then(function (data) {
                if (!observer.closed) {
                    observer.next(data);
                    observer.complete();
